---
subject: '[Algorithm] LeetCode : Sort Colors, Merge Sorted Array, Find Peak Element'
date: '2021-05-20'
category: ['Algorithm']
...
<Typography variant="h3" backgroundColor="gray">
  <span>알고리즘 기초 다지기 프로젝트 (feat. 코드없는 프로그래밍) [2021년 05월 20일]</span>
</Typography>
...
<Typography variant="h4">
  <span>Leetcode - Sort Colors</span>
</Typography>
...
<Typography variant="h4">
  <span>Leetcode - Merge Sorted Array</span>
</Typography>
...
<Typography variant="h4">
  <span>Leetcode - Find Peak Element</span>
</Typography>
